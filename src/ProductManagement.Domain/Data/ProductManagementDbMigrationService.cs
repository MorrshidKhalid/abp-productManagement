...
public class ProductManagementDbMigrationService : ITransientDependency
{
    public ILogger<ProductManagementDbMigrationService> Logger { get; set; }
    ...
    private async Task SeedDataAsync(Tenant? tenant = null)
    {
        ...
        await _dataSeeder.SeedAsync(new DataSeedContext(tenant?.Id)
            .WithProperty(IdentityDataSeedContributor.AdminEmailPropertyName,
                ProductManagementConsts.AdminEmailDefaultValue)
            .WithProperty(IdentityDataSeedContributor.AdminPasswordPropertyName,
                ProductManagementConsts.AdminPasswordDefaultValue)
        );
    }
