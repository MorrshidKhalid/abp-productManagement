...
{
    public class ProductManagmentDataSeedContributor :
        IDataSeedContributor, ITransientDependency
    {
        ...
        public ProductManagmentDataSeedContributor(IRepository<Category, Guid> categoryRepository, IRepository<Product, Guid> productRepository)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _categoryRepository.InsertManyAsync([monitors, printers]);
            ...
            await _productRepository.InsertManyAsync([monitor1, monitor2, printer1]);
        }
    }
}
